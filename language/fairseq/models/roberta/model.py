...
from fairseq.modules import LayerNorm, SquadClassificationHead
...
class RobertaModel(FairseqEncoderModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if classification_head_name is not None:
            if 'paragraph_mask' in kwargs:
                x = self.classification_heads[classification_head_name](
					x, paragraph_mask=kwargs['paragraph_mask'])
            else:
    ...
    def register_squad_head(self, name, predict_has_ans):
        self.classification_heads[name] = SquadClassificationHead(
            self.args.encoder_embed_dim, predict_has_ans)
    ...
    def upgrade_state_dict_named(self, state_dict, name):
        ...
        for k in state_dict.keys():
            ...
            if head_name == 'squad_span_classification_head':
                num_classes = state_dict[
                    prefix + "classification_heads." + head_name + ".qa_outputs.weight"
                ].size(0)
            ...
            if getattr(self.args, "load_checkpoint_heads", False):
                ...
                elif (not head_name == 'squad_span_classification_head') and (
                    num_classes
