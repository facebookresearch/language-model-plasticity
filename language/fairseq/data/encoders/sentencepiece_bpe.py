...
class SentencepieceBPE(object):
    ...
    def encode(self, x: str, out_type=str) -> str:
        # Yihong Hack 22-07-2022, out_type
        encoded = self.sp.Encode(x, out_type=out_type, enable_sampling=self.enable_sampling, alpha=self.alpha)
        if out_type == int:
